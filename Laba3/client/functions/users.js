var main = function (UsersObjects) {
	...
	var $input = $("<input>").addClass("inputStyleUser"),
		$butRegister = $("<button>").text("Создать аккаунт").addClass("buttonUser"),
		$butLogin = $("<button>").text("Войти в аккаунт").addClass("buttonUser"),
		$butEdit = $("<button>").text("Изменить имя пользователя").addClass("buttonUser"),
		$butDestroy = $("<button>").text("Удалить пользователя").addClass("buttonUser");
	...
	$("main .centerInfo .logOrRegRefBlock").append($butDestroy);
	$("main .centerInfo .logOrRegRefBlock").append($butEdit);
	$("main .centerInfo .logOrRegRefBlock").append($butLogin);
	$("main .centerInfo .logOrRegRefBlock").append($butRegister);
